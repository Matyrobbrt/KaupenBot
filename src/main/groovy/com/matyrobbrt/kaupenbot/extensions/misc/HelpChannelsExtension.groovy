...
You can share files by posting them as an attachment on Discord, and then you can react with 🗒️ to the message to create a gist.
...
'''.trim()
    ...
    void subscribeEvents(JDA jda) {
        jda.subscribe(ChannelCreateEvent) {
            ...
            WebhookMessageSender.send(WEBHOOKS.getWebhook(thread), CREATION_MESSAGE, ATTACHMENTS)
                .thenAccept {
