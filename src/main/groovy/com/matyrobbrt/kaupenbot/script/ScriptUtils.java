...
import com.matyrobbrt.kaupenbot.extensions.MiscExtension;
        ...
        try {
            return message.submit()
                    ...
                    .thenApply(msg -> {
                        ...
                        final MiscExtension.Quoter quoter1;
                        if (quoter == null) {
                            quoter1 = null;
                        } else {
                            quoter1 = new MiscExtension.Quoter(
                        ...
                        return MiscExtension.reference(msg, quoter1);
                    }).get();
        } catch (Exception e) {
